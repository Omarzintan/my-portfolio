...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void ignoresOptionalAttendee() {
    // Have each person have different events. Have an optional attendee who has an all-day event.
    // This attendee should be ignored.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void considersOptionalAttendee() {
    // Have each person have different events. Have an optional attendee whose schedule allows for them to 
    // attend the event. This attendee should be considered in making possible meeting times.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeesOverlapping() {
    // Have an event for each optional attendee, but have their events overlap. We should only see two options.
    //
    // Events  :       |--A--|
    //                     |--B--|
    // Day     : |---------------------|
  ...
  @Test
  public void optionalAttendeesNestedEvents() {
    // Have an event for each optional attendee, but have one person's event fully contain another's event. We
    // should see two options.
    //
    // Events  :       |----A----|
    //                   |--B--|
  ...
  @Test
  public void optionalAttendeesDoubleBooked() {
    // Have one optional attendee, but have them registered to attend two events at the same time.
    //
    // Events  :       |----A----|
    //                     |--A--|
    // Day     : |---------------------|
  ...
  @Test
  public void optionalAttendeesNoGapAvailable() {
    // Have each person have different events. Have an optional attendee who has an all-day event.
    // This attendee should be ignored.
    //
    // Events  : |--------------A--------------|     
